...
function conditionalDelay(condition, timeInMsec) {
  return (canisterId, requestId, status) => __async(this, null, function* () {
...
function pollForResponse(_0, _1, _2) {
  return __async(this, arguments, function* (agent, canisterId, requestId, strategy = defaultStrategy(), request2, blsVerify2) {
    var _a;
    const path = [new TextEncoder().encode("request_status"), requestId];
    const currentRequest = request2 !== null && request2 !== void 0 ? request2 : yield (_a = agent.createReadStateRequest) === null || _a === void 0 ? void 0 : _a.call(agent, {
      paths: [path]
    });
    const state = yield agent.readState(canisterId, {
      paths: [path]
...
var Actor = class _Actor {
  ...
  static createCanister(config, settings) {
    return __async(this, null, function* () {
      ...
      const {
        canister_id: canisterId
      } = yield getManagementCanister(config || {}).provisional_create_canister_with_cycles({
        amount: [],
  ...
  static createAndInstallCanister(interfaceFactory, fields, config) {
    return __async(this, null, function* () {
      ...
      yield this.install(Object.assign({}, fields), Object.assign(Object.assign({}, config), {
        canisterId
      }));
...
function _createActorMethod(actor, methodName, func, blsVerify2) {
  ...
  if (func.annotations.includes("query") || func.annotations.includes("composite_query")) {
    caller = (options, ...args) => __async(this, null, function* () {
      var _a, _b;
    ...
    caller = (options, ...args) => __async(this, null, function* () {
      ...
      if (response.status === 202) {
        ...
        const response2 = yield pollForResponse(agent, ecid, requestId, pollStrategy, blsVerify2);
...
function getManagementCanister(config) {
  ...
  return Actor.createActor(management_idl_default, Object.assign(Object.assign(Object.assign({}, config), {
...
function fetchCandid(canisterId, agent) {
  return __async(this, null, function* () {
    if (!agent) {
      agent = yield HttpAgent.create();
    }
